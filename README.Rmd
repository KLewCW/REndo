...
(7) two-stage nonparametric copula endogeneity correction (Hu et al. 2025)

(8) nonparametric control function with asymptotic theory (Breitung et al. 2024)

(9) multilevel GMM (Kim and Frees 2007)
...
Below, we present the syntax for each of the 8 implemented instrument-free methods:
